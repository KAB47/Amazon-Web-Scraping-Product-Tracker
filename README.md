...
Scrapes the title and price of a Dell XPS 15 listing on Amazon UK daily using BeautifulSoup and Requests, appends each reading to a CSV with a timestamp, and loops automatically every 24 hours to build a price history dataset.
